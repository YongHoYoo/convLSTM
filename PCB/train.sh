...
CUDA_VISIBLE_DEVICES=2 python3 main.py --lr 1e-4 --dropout 0. --h_dropout 0. --train_folder "train_none" --valid_folder "valid_none"&
CUDA_VISIBLE_DEVICES=3 python3 main.py --lr 1e-4 --dropout 0. --h_dropout 0. --gate --train_folder "train_attn" --valid_folder "valid_attn"&
